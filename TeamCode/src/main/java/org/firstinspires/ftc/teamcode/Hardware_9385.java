...
public class Hardware_9385 {
    ...
    public DcMotor Lefty2;  //left drive train motorz

    public DcMotor Righty1;
    public DcMotor Righty2; //right drive train motorz

    public DcMotor Raise;   //glyph mechanism

    public Servo Grab1; // glyph grabberz
    public Servo Grab2;
    public Servo JewlKnocker; //jewel mechanism
    ...
    public void init(HardwareMap ahwMap){
        ...
        Raise = hwMap.get(DcMotor.class, "raise");

        Grab1 = hwMap.get(Servo.class, "grab1");
        Grab2 = hwMap.get(Servo.class, "grab2");
