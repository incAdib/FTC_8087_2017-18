...
@Autonomous (name = "Auto 8088 Blue 2", group = "8088")
//@Disabled
/**
 * Created by Emmanuel on 12/7/2017.
 */

public class Auto_8088_Blue2 extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        while (opModeIsActive()) {
            ...
            brobot.JewelKnocker.setPosition(ATTACK_POSITION);
            pause();
            ...
            encoderDrive(DRIVE_SPEED, -10, -10, 1.6);
            pause();
            end();
        }
